...
nohup echo "gauge.signed.20:10|g" | nc -w 1 -u 127.0.0.1 8125 &
nohup echo "gauge.signed.20:+15|g" | nc -w 1 -u 127.0.0.1 8125 &
nohup echo "gauge.signed.20:-5|g" | nc -w 1 -u 127.0.0.1 8125 &

nohup echo "gauge.signed.5:+10|g" | nc -w 1 -u 127.0.0.1 8125 &
nohup echo "gauge.signed.5:-5|g" | nc -w 1 -u 127.0.0.1 8125 &
...
# nohup echo "counter.tag.true:1|c|#true:yes" | nc -w 1 -u 127.0.0.1 8125 &
# nohup echo "counter.tag.sparseDataStrategy:1|c|#sparseDataStrategy:ReplaceWithZero" | nc -w 1 -u 127.0.0.1 8125 &
# nohup echo "counter.tag.unit:1|c|#unit:bytes" | nc -w 1 -u 127.0.0.1 8125 &
